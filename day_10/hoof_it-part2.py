...
args = get_args(10, "Hoof It (Part 2)")
...
def get_trailhead_rating(trailhead_position, elevation_map):
    """
    Calculates the rating of a path starting from a trailhead at elevation 0. The score
    is defined as the number of distinct hiking trails to all positions with elevation 9
    that originate from that trailhead.
...
for trailhead in trailhead_positions:
    sum_trailhead_ratings += get_trailhead_rating(trailhead, trail_map)
